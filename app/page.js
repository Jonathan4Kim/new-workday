        ...
        <main className="bg-dark-blue">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
              <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  <a
                    ...
                    className="rounded-md bg-orange px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-orange-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-400"
                  >
              ...
              <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
                <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                  <Image src={"/images/applicantflow.png"} alt="logo" className="w-[76rem] rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10"/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-32 sm:mt-56">
            ...
            <div className="relative overflow-hidden pt-16">
              <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <Image src={"/images/JobApplication.png"} alt="app screenshot" width={2432} height={1442} className="mb-[-12%] rounded-xl shadow-2xl ring-1 ring-white/10"/>
